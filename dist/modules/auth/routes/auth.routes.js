 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/register/step1', rate_limit_middleware_1.registrationRateLimit, (0, validation_middleware_1.validateRequest)(auth_validation_1.registerStep1Schema), authController.registerStep1.bind(authController));
/**
 * @swagger
 * /auth/register/step2:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/register/step2', (0, validation_middleware_1.validateRequest)(auth_validation_1.registerStep2Schema), authController.registerStep2.bind(authController));
/**
 * @swagger
 * /auth/register/step3:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/register/step3', (0, validation_middleware_1.validateRequest)(auth_validation_1.registerStep3Schema), authController.registerStep3.bind(authController));
/**
 * @swagger
 ...
 *     tags: [Auth]
 */
router.get('/register/status/:email', authController.getRegistrationStatus.bind(authController));
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/register/preview-identifier', authController.previewCompanyIdentifier.bind(authController));
/**
 * @swagger
 ...
 *     tags: [Auth]
 */
router.post('/register/resend-email', authController.resendRegistrationEmail.bind(authController));
// ===================================================================
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/login/initiate', rate_limit_middleware_1.authRateLimit, (0, validation_middleware_1.validateRequest)(auth_validation_1.loginInitiateSchema), authController.loginInitiate.bind(authController));
/**
 * @swagger
 * /auth/login/verify:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/login/verify', rate_limit_middleware_1.otpRateLimit, (0, validation_middleware_1.validateRequest)(auth_validation_1.loginVerifySchema), authController.loginVerify.bind(authController));
/**
 * @swagger
 ...
 *     tags: [Auth]
 */
router.post('/login/resend-otp', rate_limit_middleware_1.otpRateLimit, authController.resendLoginOtp.bind(authController));
/**
 * @swagger
 ...
 */
router.post('/workspace/check-access', authController.checkWorkspaceAccess.bind(authController));
/**
 * @swagger
 ...
 *     tags: [Auth]
 */
router.get('/workspaces/:email', authController.getWorkspaces.bind(authController));
// ===================================================================
 ...
 */
router.post('/totp/login/initiate', rate_limit_middleware_1.authRateLimit, (0, validation_middleware_1.validateRequest)(auth_validation_1.totpLoginInitiateSchema), authController.totpLoginInitiate.bind(authController));
/**
 * @swagger
 ...
 */
router.post('/totp/login/verify', rate_limit_middleware_1.otpRateLimit, (0, validation_middleware_1.validateRequest)(auth_validation_1.totpLoginVerifySchema), authController.totpLoginVerify.bind(authController));
/**
 * @swagger
 * /auth/2fa/setup:
 *   post:
 ...
 */
router.post('/2fa/enable', (0, validation_middleware_1.validateRequest)(auth_validation_1.enable2FASchema), authController.enable2FA.bind(authController));
/**
 * @swagger
 * /auth/2fa/disable:
 *   post:
 ...
 */
router.post('/2fa/disable', (0, validation_middleware_1.validateRequest)(auth_validation_1.disable2FASchema), authController.disable2FA.bind(authController));
/**
 * @swagger
 * /auth/2fa/status:
 *   get:
 ...
 */
router.get('/2fa/status', authController.get2FAStatus.bind(authController));
// ===================================================================
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/ui/register', (0, validation_middleware_1.validateRequest)(auth_validation_1.singlePageRegistrationSchema), authController.registerSinglePage.bind(authController));
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/ui/login/step1/company', (0, validation_middleware_1.validateRequest)(auth_validation_1.companyValidationSchema), authController.validateCompanyIdentifier.bind(authController));
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/ui/login/step2/username', (0, validation_middleware_1.validateRequest)(auth_validation_1.usernameValidationSchema), authController.validateUsername.bind(authController));
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/ui/login/step3/password', (0, validation_middleware_1.validateRequest)(auth_validation_1.passwordValidationSchema), authController.validatePassword.bind(authController));
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/ui/login/step4/totp', (0, validation_middleware_1.validateRequest)(auth_validation_1.totpLoginVerifySchema), authController.completeTOTPLogin.bind(authController));
/**
 * @swagger
 ...
 */
router.post('/ui/2fa/force-setup', authController.force2FASetup.bind(authController));
