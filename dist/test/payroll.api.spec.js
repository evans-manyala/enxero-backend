...
describe('Payroll API Integration', () => {
    ...
    it('should create a payroll record', async () => {
        const periodRes = await (0, supertest_1.default)(app_1.default)
        ...
        const employeeRes = await (0, supertest_1.default)(app_1.default)
    ...
    it('should get all payroll records', async () => {
        ...
        expect(res.body.data.some((p) => p.id === payrollId)).toBe(true);
    });
    ...
    it('should update a payroll record', async () => {
        const existingRecordRes = await (0, supertest_1.default)(app_1.default)
            .get(`/api/v1/payroll/records/${payrollId}`)
            .set('Authorization', `Bearer ${accessToken}`);
